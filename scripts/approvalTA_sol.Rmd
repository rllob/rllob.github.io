...
```{r}
m1 <- lm(approve_TA ~ polisci, data = dat)

summary(m1)


m2 <- lm(approve_TA ~ econ, data = dat)

summary(m2)


m3 <- lm(approve_TA ~ soc, data = dat)
...
```{r}
m1 <- lm(approve_TA ~ polisci + econ, data = dat)

summary(m1)


m2 <- lm(approve_TA ~ polisci + soc, data = dat)

summary(m2)


m3 <- lm(approve_TA ~ econ + soc, data = dat)
...
```{r}
m1 <- lm(approve_TA ~ age, data = dat)
m2 <- lm(approve_TA ~ age + econ, data = dat)
m3 <- lm(approve_TA ~ age + econ + female, data = dat)
```
...
```{r}
m4 <- lm(approve_TA ~ age + female + age:female, data = dat)
m4 <- lm(approve_TA ~ age*female, data = dat)
